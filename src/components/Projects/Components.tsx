...
export const projects = [
  ...
  },
  {
    ...
    title: 'API ',
    img: api,
    description: 'API de usuarios com python desenvolvida com FastAPI, SQLAlchemy e MySQL, permitindo operações CRUD (Create, Read, Update, Delete) em um banco de dados de usuários.',
    tags: ['Python', 'FastAPI', 'SQLAlchemy', 'SQLite', 'MySQL'],
